...
contract('MagicBetTests', (accounts) => {
  ...
  beforeEach(async () => {
    ...
    const outcomeNamesArray = ['Trump', 'Biden', 'x', 'y'];
  ...
  //     await magicBetFactory.createMarket(eventName,marketOpeningTime,marketLockingTime,marketResolutionTime,30,arbitrator,question,outcomeNamesArray);
  //     await magicBetFactory.createMarket(eventName,marketOpeningTime,marketLockingTime,marketResolutionTime,30,arbitrator,question,outcomeNamesArray);
  //     await magicBetFactory.createMarket(eventName,marketOpeningTime,marketLockingTime,marketResolutionTime,30,arbitrator,question,outcomeNamesArray);
  //     await magicBetFactory.createMarket(eventName,marketOpeningTime,marketLockingTime,marketResolutionTime,30,arbitrator,question,outcomeNamesArray);
  //     await magicBetFactory.createMarket(eventName,marketOpeningTime,marketLockingTime,marketResolutionTime,30,arbitrator,question,outcomeNamesArray);
  ...
  it('create market with 10 outcomes, do simple invalid outcome test', async () => {
    // // new event details
    // const arbitrator = '0x34A971cA2fd6DA2Ce2969D716dF922F17aAA1dB0';
    // const eventName = 'X';
    // var marketOpeningTime = await time.latest();
